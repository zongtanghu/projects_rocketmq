...
public class CommitLog {
    ...
    /**
     * 初始化commitlog对象时开启：物理队列刷盘服务线程--FlushCommitLogService
     * 将commitlog.mapedFileQueues刷入磁盘。
    ...
    /**
     * CommitLog.putMessage 首先将数据写入到commitlog对应的mapedFile中，每写入一条消息，
     * 通过mapedFile.appendMessage追加到MapedFile文件中，当MapedFile写满后，
     * 生成一个新的MapedFile，然后向这个MapedFile中追加消息，如此不断 ... ...，
     * 这些MapedFile装在MapedFileQueue中
     *
     * @param msg
     * @return
     */
    public PutMessageResult putMessage(final MessageExtBrokerInner msg) {
        ...
        /**
         * 这里分两个步骤（step1.先刷盘/step2.再同步至Broker的slave节点）
         */
