...
public class BrokerOuterAPI {
    ...
    private RegisterBrokerResult registerBroker(
        ...
        /**
         * 根据是否为oneWay的判断，如果是oneWay的则不需要考虑其response的值
         */
        if (oneway) {
            try {
        ...
        /**
         * 如果是同步请求则调用remotingClient.invokeSync的接口,根据reponse的code值来判断
         */
