...
public class RouteInfoManager {
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                //step2.add<clusterName,<BrokerName1,BrokerName2>>至clusterAddrTable
                ...
                //step3.add <brokeName,BrokerData>至BrokerAddrTable
                    ...
                    if (this.isBrokerTopicConfigChanged(brokerAddr, topicConfigWrapper.getDataVersion())
                        ...
                        if (tcTable != null) {
                            for (Map.Entry<String, TopicConfig> entry : tcTable.entrySet()) {
                                //step4.创建和更新topicQueueTable数据结构中的QueueData
                ...
                //step5.创建和更新brokerLiveTable数据结构中的brokerLiveInfo数据
    ...
    /**
     * 创建和更新topicQueueTable数据结构中的QueueData
     *
     * @param brokerName
     * @param topicConfig
     */
    ...
    public void scanNotActiveBroker() {
        ...
        while (it.hasNext()) {
            ...
            log.info("the current BrokerLive Info is:" + next.getValue().toString());
